...
// Import utilities instead of direct clipboardy import
...
import { writeClipboardSafe } from './lib/clipWriter'; // Import clipWriter
...
(async () => {
  ...
  try {
    ...
    if (fileStream) {
      ...
      try {
        // Use the safe clipboard writer
        await writeClipboardSafe(outputBuffer);
